...
{
    public class PlatformerUserRepository : IPlatformerUserRepository
    {
        private readonly WebDbContext _context;

        public PlatformerUserRepository(
        ...
        public async Task<PlatformerUser> GetCpfAsync(string cpf, int id)
        {
