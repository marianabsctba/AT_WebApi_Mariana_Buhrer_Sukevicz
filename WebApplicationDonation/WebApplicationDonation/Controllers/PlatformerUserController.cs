...
{
    [Authorize]
    public class PlatformerUserController : Controller
    {
        private readonly IPlatformerUserHttpService _userHttpService;

        public PlatformerUserController(
            IPlatformerUserHttpService userHttpService)
        {
            _userHttpService = userHttpService;
        }

        // GET: User
        public async Task<IActionResult> Index(PlatformerUserIndexViewModel userIndexRequest)
        {
            var userIndexViewModel = new PlatformerUserIndexViewModel
            {
        ...
        public async Task<IActionResult> Create(PlatformerUserViewModel userViewModel)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, PlatformerUserViewModel userViewModel)
        {
